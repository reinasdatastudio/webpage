...
```{r echo=FALSE, fig.cap="Figure 3: A bar graph of top 15 pt terms"}
...
```{r echo=FALSE, fig.cap="Figure 5: Categorising Severity of Outcome and the total count of each severity"}
...
```{r echo=FALSE, fig.cap="Figure 6: A bar graph visualising the severity of adverse reactions"}
...
```{r echo=FALSE, fig.cap="Figure 7: A histogram showing how many cases reported what number of reactions, coloured with severity"}
...
```{r echo=FALSE, fig.cap="Figure 8: Severe outcomes by number of reported reactions"}
